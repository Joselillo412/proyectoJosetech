...
<body>
    <div class="card">
        ...
        <div class="body">
            <p>Hola <strong><?php echo e($pedido->usuario->nombre); ?></strong>,</p>
            ...
            <div class="code-box">
                ...
                <div class="code"><?php echo e($pedido->codigo_seguimiento); ?></div>
            ...
            <ul>
                <li><strong>Dispositivo:</strong> <?php echo e($pedido->dispositivo->marca); ?> <?php echo e($pedido->dispositivo->modelo); ?></li>
                <li><strong>Intervenciones:</strong> <?php echo e($pedido->tipo_reparacion); ?></li>
                <li><strong>Precio Estimado:</strong> <?php echo e($pedido->precio_estimado); ?></li>
            </ul>
        ...
        <div class="footer">
            Este es un correo automático, por favor no respondas si no es necesario. © <?php echo e(date('Y')); ?> Josetech.
        </div>
    </div>
</body>

</html><?php /**PATH C:\Users\joseb\Documents\GIT\proyectoJosetech\backend\resources\views/emails/pedido_cliente.blade.php ENDPATH**/ ?>