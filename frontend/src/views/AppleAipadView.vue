...
onMounted(async () => {
    try {
        ...
        modelos.value = datos.filter(d => d.marca === 'Apple' && d.tipo === 'Tablet')
    ...
    <section class="apple">
        ...
        <div v-if="!cargando && !error" class="apple__search-wrapper">
            <div class="apple__search">
                ...
                <input v-model="busqueda" type="text" class="apple__search-input"
                    placeholder="Busca tu iPad... (ej: iPad Pro, Air, mini)" />
        ...
        <template v-else>
            <div v-if="modelosFiltrados.length === 0" class="apple__empty">
                ...
                <p>No hay ningún iPad que coincida con "<strong>{{ busqueda }}</strong>"</p>
